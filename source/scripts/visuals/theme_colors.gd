...
export(Color) var _texture_accent_color
...
var texture_accent_color setget , get_texture_accent_color
...
func get_texture_accent_color():
	return _texture_accent_color
